...
select
  ...
  '[{"treatment":"Dental Implant","coverage":"Implant Fixture & Abutment","period":"5 Years"},{"treatment":"Crown & Bridges","coverage":"Zirconia / E-max Restorations","period":"2 Years"},{"treatment":"Veneers","coverage":"Porcelain Veneers","period":"1 Year"},{"treatment":"Composite Restorations","coverage":"Composite Fillings & Bonding","period":"1 Year"}]'::jsonb,
  '["Defects in workmanship related to restorative or implant treatment.","Failure of crowns, bridges, veneers, composite restorations, or implant restorations due to material or manufacturing defects.","Implant fixture failure resulting from loss of osseointegration or treatment-related factors, as determined by clinical and radiographic evaluation.","Loosening of implant components or abutment screws caused by workmanship or material defects.","Fracture, debonding, or failure of composite restorations resulting from material or workmanship defects.","Necessary repair, replacement, or adjustment of covered restorations when approved by Roomchang Dental Hospital."]'::jsonb,
  '["Requests for cash refunds or financial reimbursement.","Treatment that has been modified, repaired, or adjusted by another dentist or healthcare provider.","Damage resulting from trauma, accidents, sports injuries, or external forces.","Failure caused by smoking, tobacco use, poor oral hygiene, or non-compliance with professional instructions.","Teeth grinding (bruxism) where a protective night guard was recommended but not used.","Failure to attend recommended maintenance and review appointments.","Natural changes in surrounding teeth, gums, or bone structure.","Cosmetic concerns that do not affect the function or integrity of the restoration.","Normal wear and tear over time."]'::jsonb,
  '["Attend routine dental examinations and maintenance visits every 6–12 months.","Follow all post-treatment care instructions provided by the treating dentist.","Maintain good oral hygiene practices.","Inform Roomchang Dental Hospital promptly if any issue or complication arises.","Present evidence of routine dental maintenance if receiving care outside Roomchang Dental Hospital."]'::jsonb,
  ...
  '["The 20% discount applies only to professional treatment fees.","The discount does not apply to laboratory fees, implant components, restorative materials, medications, radiographs, or other third-party costs.","Eligibility is subject to clinical evaluation and approval by Roomchang Dental Hospital.","The discount applies only to the original patient and the original treatment provided by Roomchang Dental Hospital.","Patients must have attended recommended maintenance visits every 6–12 months to remain eligible.","This benefit is non-transferable and cannot be exchanged for cash or combined with other promotions.","Roomchang Dental Hospital reserves the right to modify or discontinue this benefit without prior notice."]'::jsonb,
