// Full country calling-code list (alphabetical). Source: restcountries.com.
export type DialCode = { flag: string; code: string; name: string };

export const DIAL_CODES: DialCode[] = [
  { flag: "🇦🇫", code: "+93", name: "Afghanistan" },
  { flag: "🇦🇽", code: "+35818", name: "Åland Islands" },
  ...
  { flag: "🇧🇻", code: "+47", name: "Bouvet Island" },
  ...
  { flag: "🇧🇶", code: "+599", name: "Caribbean Netherlands" },
  ...
  { flag: "🇫🇰", code: "+500", name: "Falkland Islands" },
  { flag: "🇫🇴", code: "+298", name: "Faroe Islands" },
  { flag: "🇫🇯", code: "+679", name: "Fiji" },
  { flag: "🇫🇮", code: "+358", name: "Finland" },
  { flag: "🇫🇷", code: "+33", name: "France" },
  { flag: "🇬🇫", code: "+594", name: "French Guiana" },
  { flag: "🇵🇫", code: "+689", name: "French Polynesia" },
  { flag: "🇹🇫", code: "+262", name: "French Southern and Antarctic Lands" },
  ...
  { flag: "🇳🇫", code: "+672", name: "Norfolk Island" },
  ...
  { flag: "🇵🇳", code: "+64", name: "Pitcairn Islands" },
  { flag: "🇵🇱", code: "+48", name: "Poland" },
  { flag: "🇵🇹", code: "+351", name: "Portugal" },
  { flag: "🇵🇷", code: "+1", name: "Puerto Rico" },
  { flag: "🇶🇦", code: "+974", name: "Qatar" },
  { flag: "🇨🇬", code: "+242", name: "Republic of the Congo" },
  { flag: "🇷🇪", code: "+262", name: "Réunion" },
  { flag: "🇷🇴", code: "+40", name: "Romania" },
  { flag: "🇷🇺", code: "+7", name: "Russia" },
  { flag: "🇷🇼", code: "+250", name: "Rwanda" },
  { flag: "🇧🇱", code: "+590", name: "Saint Barthélemy" },
  { flag: "🇸🇭", code: "+2", name: "Saint Helena, Ascension and Tristan da Cunha" },
  { flag: "🇰🇳", code: "+1869", name: "Saint Kitts and Nevis" },
  { flag: "🇱🇨", code: "+1758", name: "Saint Lucia" },
  { flag: "🇲🇫", code: "+590", name: "Saint Martin" },
  { flag: "🇵🇲", code: "+508", name: "Saint Pierre and Miquelon" },
  ...
  { flag: "🇬🇸", code: "+500", name: "South Georgia" },
  ...
  { flag: "🇸🇯", code: "+4779", name: "Svalbard and Jan Mayen" },
  ...
  { flag: "🇹🇨", code: "+1649", name: "Turks and Caicos Islands" },
  ...
  { flag: "🇺🇲", code: "+268", name: "United States Minor Outlying Islands" },
  { flag: "🇻🇮", code: "+1340", name: "United States Virgin Islands" },
  { flag: "🇺🇾", code: "+598", name: "Uruguay" },
  { flag: "🇺🇿", code: "+998", name: "Uzbekistan" },
  { flag: "🇻🇺", code: "+678", name: "Vanuatu" },
  { flag: "🇻🇦", code: "+3", name: "Vatican City" },
  { flag: "🇻🇪", code: "+58", name: "Venezuela" },
  { flag: "🇻🇳", code: "+84", name: "Vietnam" },
  { flag: "🇼🇫", code: "+681", name: "Wallis and Futuna" },
  { flag: "🇪🇭", code: "+2", name: "Western Sahara" },
