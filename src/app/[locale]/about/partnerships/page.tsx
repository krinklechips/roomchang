...
const PARTNER_CATEGORIES: PartnerCategory[] = [
  {
    ...
    partners: [
      { name: "Vattanac Bank",           logo: "/partners/vattanac-bank.jpg" },
      { name: "Cambodia Post Bank",       logo: "/partners/cambodia-post-bank.webp" },
      { name: "Chip Mong Bank",           logo: "/partners/chip-mong-bank.png" },
      { name: "Prince Bank" },
      { name: "BRED Bank",                logo: "/partners/bred-bank.webp" },
      { name: "Phillip Bank",             logo: "/partners/phillip-bank.svg" },
      { name: "Maybank",                  logo: "/partners/maybank.png" },
      { name: "PPC Bank",                  logo: "/partners/ppc-bank.png" },
      { name: "ACLEDA Bank",              logo: "/partners/acleda-bank.png" },
      { name: "Canadia Bank",             logo: "/partners/canadia-bank.png" },
      { name: "Sacom Bank",               logo: "/partners/sacom-bank.jpg" },
      { name: "ABA Bank",                  logo: "/partners/aba-bank.webp" },
      { name: "CIMB Bank",                logo: "/partners/cimb-bank.jpg" },
      { name: "Hatha Kaksekar Limited" },
      { name: "Cambodian Public Bank",    logo: "/partners/cambodian-public-bank.webp" },
      { name: "Hong Leong Bank",          logo: "/partners/hong-leong-bank.webp" },
      { name: "Sathapana Bank",           logo: "/partners/sathapana-bank.png" },
      { name: "Union Commercial Bank" },
      { name: "AEON Specialized Bank" },
      { name: "Oriental Bank",            logo: "/partners/oriental-bank.jpg" },
      { name: "Bridge Bank" },
      { name: "CCU Bank" },
    ],
  },
  ...
  },
  {
    title: "Insurance",
    partners: [
      { name: "AIA",       logo: "/partners/aia.svg" },
  ...
  },
  {
    ...
    partners: [
      ...
      { name: "Sofitel Hotel",             logo: "/partners/sofitel.svg" },
    ],
  },
  {
  ...
  },
  {
    ...
    partners: [
      ...
      { name: "AmCham Cambodia",           logo: "/partners/amcham.svg" },
      { name: "IDI" },
    ],
  },
  {
    title: "Other",
    partners: [
      { name: "PwC Cambodia", logo: "/partners/pwc.svg" },
      { name: "Pathmazing" },
      { name: "Dragonair" },
      { name: "Peace Corps" },
    ],
