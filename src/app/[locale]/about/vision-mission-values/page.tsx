      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 sm:py-20 lg:px-8">
        ...
        <div className="grid gap-6 sm:grid-cols-2">
          <div className="rounded-3xl border border-[color:var(--border-strong)] bg-white p-10 shadow-[0_12px_40px_rgba(57,28,45,0.05)]">
            <p className="text-xs font-semibold uppercase tracking-[0.28em] text-[color:var(--brand)]">Vision</p>
          ...
          <div className="rounded-3xl border border-[color:var(--border-strong)] bg-white p-10 shadow-[0_12px_40px_rgba(57,28,45,0.05)]">
            <p className="text-xs font-semibold uppercase tracking-[0.28em] text-[color:var(--brand)]">Mission</p>
            <p className="mt-4 font-display text-4xl leading-tight text-[color:var(--text-main)]">
        ...
        {/* Values */}
        <div className="mt-20">
          <h2 className="font-display text-4xl text-[color:var(--text-main)]">Our Core Values</h2>
          ...
          <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-5">
            {VALUES.map((value) => (
              ...
              >
                ...
                <h3 className="mt-3 font-display text-2xl text-[color:var(--brand-deep)]">{value.title}</h3>
                <p className="mt-3 text-sm leading-6 text-[color:var(--text-soft)]">{value.description}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="mt-20 rounded-3xl bg-[color:var(--brand-soft)] p-10 sm:p-12">
          <div className="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <h2 className="font-display text-3xl text-[color:var(--text-main)]">See our values in action</h2>
