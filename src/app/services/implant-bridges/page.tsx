    ...
    <SiteShell>
      ...
      <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 sm:py-16 lg:px-8 space-y-16">
        ...
        <div className="grid gap-6 sm:grid-cols-3">
          {[
            { icon: "💪", title: "Lifetime Warranty", body: "Our implant-supported bridges are solid, reliable, and backed by a lifetime warranty." },
            { icon: "🔬", title: "Long-term Tissue Stability", body: "The implant system is designed to prevent bone resorption while protecting your gums." },
            { icon: "💰", title: "Economical", body: "Replace multiple missing teeth using only two implants rather than one per tooth." },
          ].map((b) => (
