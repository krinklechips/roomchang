      ...
      <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 sm:py-16 lg:px-8 space-y-16">
        ...
        <div>
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {[
              { icon: "🦴", benefit: "Preserves jawbone and prevents facial structure changes" },
              { icon: "😊", benefit: "Prevents premature wrinkles from shifting facial contours" },
              { icon: "🍽️", benefit: "Restores better chewing function and clearer speech" },
              { icon: "✨", benefit: "Eliminates the need for denture creams and adhesives" },
            ].map((b) => (
