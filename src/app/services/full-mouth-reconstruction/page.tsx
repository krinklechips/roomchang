      ...
      <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 sm:py-16 lg:px-8 space-y-16">
        ...
        <div>
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {[
              { icon: "😌", title: "Pain Relief", body: "Eliminating improper bite forces relieves jaw, neck, and head pain." },
              { icon: "🦷", title: "Restored Function", body: "Eat and speak comfortably with a stable, well-aligned bite." },
              { icon: "✨", title: "Improved Aesthetics", body: "Rebuild and beautify the entire mouth for a natural, youthful appearance." },
              { icon: "🛡️", title: "Long-term Health", body: "Protect remaining teeth from further wear and bone from further loss." },
            ].map((b) => (
