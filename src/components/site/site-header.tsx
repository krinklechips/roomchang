...
const NAV_ITEMS: NavItem[] = [
  ...
  { label: "About", href: "/about" },
  {
    ...
    children: [
      ...
      { label: "Implant Bridges", href: "/services#implants" },
      { label: "All-on-4 / All-on-6", href: "/services#implants" },
